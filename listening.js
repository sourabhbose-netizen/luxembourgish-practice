...
const SPROOCHENTEST_QUESTIONS = [
    ...
    { theme: "Schlof", question: "Wat huet Iech als Kand gehollef fir anzeschlofen?", english: "What helped you fall asleep as a child?" },
    { theme: "Schlof", question: "Wéi strikt hunn Är Elteren Är Schlofzäite kontrolléiert?", english: "How strictly did your parents control your sleep times?" },
    { theme: "Schlof", question: "Hutt Dir als Kand bei Frënn iwwernuecht?", english: "Did you sleep over at friends' as a child?" },
    { theme: "Schlof", question: "Wéi war dat? Erzielt eis!", english: "How was that? Tell us!" },
    { theme: "Schlof", question: "Wat hutt Dir alles matgeholl?", english: "What did you take with you?" },
    ...
    { theme: "Schlof", question: "Vill Leit schlofe schlecht. Firwat kann dat sinn?", english: "Many people sleep badly. Why could that be?" },
    { theme: "Schlof", question: "Wat maacht Dir, wann Dir net aschlofe kënnt?", english: "What do you do when you can't fall asleep?" },
    { theme: "Schlof", question: "Wat kann ee maache fir besser ze schlofen?", english: "What can you do to sleep better?" },
    { theme: "Schlof", question: "Maacht Dir dat heiansdo?", english: "Do you do that sometimes?" },
    { theme: "Schlof", question: "Wat fir planzlech Mëttel oder traditionell Rezepter kennt Dir?", english: "What herbal remedies or traditional recipes do you know?" },
    { theme: "Schlof", question: "Wat haalt Dir vu Schlofpëllen?", english: "What do you think about sleeping pills?" },
    { theme: "Schlof", question: "Wat fir eng Zort Wecker benotzt Dir?", english: "What kind of alarm clock do you use?" },
    { theme: "Schlof", question: "Wéini hutt Dir Iech fir d'lescht verschlof?", english: "When did you last oversleep?" },
    { theme: "Schlof", question: "Firwat war dat passéiert?", english: "Why did that happen?" },
    { theme: "Schlof", question: "Wat hutt Dir du gemaach?", english: "What did you do then?" },
    { theme: "Schlof", question: "Wat haalt Dir dovun, nom Iessen ze schlofen?", english: "What do you think about sleeping after eating?" },
    { theme: "Schlof", question: "Wat haalt Dir vun enger Televisioun am Schlofzëmmer?", english: "What do you think about a TV in the bedroom?" },
    { theme: "Schlof", question: "Wéi waarm ass Äert Schlofzëmmer?", english: "How warm is your bedroom?" },
    { theme: "Schlof", question: "Firwat ass dat esou?", english: "Why is that so?" },
    ...
    { theme: "Schlof", question: "Firwat?", english: "Why?" },
    { theme: "Schlof", question: "Géingt Dir gär e Wellness-Weekend maachen?", english: "Would you like to do a wellness weekend?" },
    { theme: "Schlof", question: "Mat wiem géingt Dir dat gär maachen?", english: "With whom would you like to do that?" },
    { theme: "Schlof", question: "Wat géingt Dir do maachen?", english: "What would you do there?" },
    // AARBECHT
